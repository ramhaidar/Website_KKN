...
@if ($sudah_punya_dpl == true)
                        ...
                        <div class="card-body text-white flex-grow-1">
                            <div class="container-fluid m-0 p-0 w-100 h-100">
                                ...
                                <form class="container-fluid p-0 m-0 pt-1 w-100 h-100" id="FormLaporan"
                                    enctype="multipart/form-data" method="POST" action="{{ route('dosen.laporan_akhir.update', $laporan_akhir) }}">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="container-fluid p-0 m-0 mb-3 mt-4">
                                        ...
                                        <textarea class="form-control" id="revisi_pembimbing" name="revisi_pembimbing"
                                            placeholder="[ Belum ada Revisi ]" required>{{$laporan_akhir->revisi}}</textarea>
                                    </div>
        ...
        <div class="modal fade" id="ModalKonfirmasiApprove" aria-labelledby="ModalKonfirmasiApprove" aria-hidden="true"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form id="approve-form" action="{{ route('dosen.laporan_akhir.approve', $laporan_akhir) }}" method="POST" class="d-none">
                        @csrf
                    </form>
                </div>
            </div>
    ...
    @section('Body_JS')
        <script>
            var baseUrl = "{{ route('dosen.laporan_akhir.index') }}";
