                        ...
                        <div class="container-fluid p-0 m-0 w-100 h-100">
                            <div class="row justify-content-between px-3 mb-3">
                                <div class="col p-0 m-0">
                                    <h5 class="card-title pb-3 fs-6">Jumlah Dosen Pembimbing Lapangan: <i
                                ...
                                <div class="col p-0 m-0">
                                    ...
                                    <div class="row justify-content-end w-100px-3 mb-3">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{ route('admin.dosen_pembimbing_lapangan.create') }}"
                                                class="btn btn-success shadow-sm border border-3 border-light-subtle">
                                                <i class="bi bi-person-plus-fill me-2"></i>
                                                Tambah Dosen Pembimbing Lapangan
                                            </a>
                                        </div>
                                    </div>
                                    {{-- </div> --}}
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Apakah Anda yakin ingin menghapus Dosen Pembimbing Lapangan ini?
            </div>
            <div class="modal-footer">
                ...
                <form method="POST" action="" id="form-delete-dosen">
                    @csrf
                    @method('DELETE')
...
@section('Body_JS')
    <script>
        var baseUrl = "{{ route('admin.dosen_pembimbing_lapangan.index') }}";
    ...
    <script>
        function loadData(page) {
            $.ajax({
                url: "{{ route('admin.dosen_pembimbing_lapangan.getData') }}" + '?page=' + page,
                type: 'get',
                dataType: 'json',
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    $.each(data.DataDPL, function(index, item) {
    ...
    <script>
        $(document).ready(function() {
            $(document).on("click", ".btn-delete", function () {
                ...
                $("#form-delete-dosen").attr("action", action);
            });
            ...
            $('#LastButtonUpper, #LastButtonLower').click(function() {
                $.ajax({
                    url: "{{ route('admin.dosen_pembimbing_lapangan.lastData') }}", // The endpoint that returns the last page number
                    type: 'get',
            ...
            $('#SearchForm').on('keyup', function(e) {
                ...
                if (e.keyCode === 13) { // 13 is the key code for Enter
                    ...
                    if (searchQuery != '') {
                        ...
                        $.ajax({
                            url: "{{ route('admin.dosen_pembimbing_lapangan.findData') }}" + '?query=' + searchQuery,
                            type: 'get',
                            dataType: 'json',
                            beforeSend: function() {
                                console.log("Fetching Data...");
