                                ...
                                <table
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <th class="fw-normal">
                                                {{ $user->mahasiswa->dpl ? $user->mahasiswa->dpl->nama_dosen : '[ Belum Ada ]' }}
                                            </th>
                                        </tr>
                                        <tr>
                                            <td>E-Mail</td>
                                            <td>{{ $user->mahasiswa->dpl ? $user->mahasiswa->dpl->user->email : '[ Belum Ada ]' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>NIP</td>
                                            <td>{{ $user->mahasiswa->dpl ? $user->mahasiswa->dpl->nip : '[ Belum Ada ]' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Prodi</td>
                                            <td>{{ $user->mahasiswa->dpl ? $user->mahasiswa->dpl->prodi : '[ Belum Ada ]' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Fakultas</td>
                                            <td>{{ $user->mahasiswa->dpl ? $user->mahasiswa->dpl->fakultas : '[ Belum Ada ]' }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{!! nl2br(e($user->mahasiswa->anggota_kelompok)) !!}</td>
                                        </tr>
                                        <tr>
                                            <td>NIM</td>
                                        ...
                                        <tr>
                                            <td>Prodi</td>
                                            <td>{{ $user->mahasiswa->prodi }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Fakultas</td>
                                            <td>{{ $user->mahasiswa->fakultas }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
