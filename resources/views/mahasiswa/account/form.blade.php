        ...
        <div class="container-fluid p-0 m-0 w-100" style="background-color: transparent">
            <div class="container-fluid py-3 pb-4 w-100" style="background-color: transparent">
                <div class="card border-secondary mb-3 flex-grow-1 d-flex flex-column p-0">
                    ...
                    <form method="POST" action="{{ route('mahasiswa.account.update') }}">
                        @csrf
                        <div class="card-body text-white flex-grow-1">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="NamaKetuaKelompok___" name="NamaKetuaKelompok___"
                                    type="text" value="{{ $user->mahasiswa->nama_ketua }}" required
                                    placeholder="Almira Nababan">
                                <label for="NamaKetuaKelompok___">Nama</label>
                            </div>
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="NIM___" name="NIM___" type="text"
                                    value="{{ $user->mahasiswa->nim }}" required placeholder="NIM___">
                                <label for="NIM___">NIM</label>
                            </div>

                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="AnggotaKelompok___" name="AnggotaKelompok___" style="height: 17vh" rows="3">{{ $user->mahasiswa->anggota_kelompok }}</textarea>
                                <label for="AnggotaKelompok___">Anggota Kelompok</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input class="form-control" id="Prodi___" name="Prodi___" type="text"
                                    value="{{ $user->mahasiswa->prodi }}" required placeholder="Prodi___">
                                <label for="Prodi___">Prodi</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input class="form-control" id="Fakultas___" name="Fakultas___" type="text"
                                    value="{{ $user->mahasiswa->fakultas }}" required placeholder="Fakultas___">
